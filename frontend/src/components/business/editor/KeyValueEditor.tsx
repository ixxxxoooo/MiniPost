              ...
              <div className="flex items-center gap-2">
                ...
                {autoGeneratedItems.length > 0 && (
                  <button
                    type="button"
                    className={cn(
                      "inline-flex h-[16px] w-[62px] items-center justify-center gap-1 rounded-full border px-1.5 text-[10px] font-medium transition-colors",
                    ...
                    title={hideAutoGenerated ? "显示自动生成请求头" : "隐藏自动生成请求头"}
                  >
                    <AppIcon name={hideAutoGenerated ? "eye" : "viewOff"} size={10} />
                    {hideAutoGenerated ? "show" : "hide"}
                  </button>
                )}
              </div>
            </th>
